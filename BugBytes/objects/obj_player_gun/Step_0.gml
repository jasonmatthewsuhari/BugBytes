...
ox = owner.weapon_x;					// Original x position (change it to player's x)
oy = owner.weapon_y;					// Original y position (change it to player's y)
...
var _shoot = gun.fullauto ? mouse_check_button(mb_right) : mouse_check_button_pressed(mb_right);
